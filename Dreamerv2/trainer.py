...
from RL.Dreamerv2.utils        import set_seed, Timer
from RL.Dreamerv2.env          import make_env
from RL.Dreamerv2.dreamerv2    import DreamerV2
...
class Trainer:
    ...
    def setup(self) -> None:
        ...
        self.agent = DreamerV2(self.c, self.train_env.action_space, self.writer, self.logdir).to(self.c.device)
        ...
        while self.global_frames < self.c.steps:
            ...
            if self.global_frames > self.c.prefill and self.global_frames % self.c.train_every == 0:
                for train_step in range(self.c.train_steps):
                    ...
                    if train_step % self.c.slow_target_update == 0:
